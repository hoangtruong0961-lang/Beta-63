    ...
    <div className={`flex flex-col items-center justify-center h-full px-4 py-6 space-y-6 overflow-y-auto custom-scrollbar transition-opacity duration-1000 ${isIntroing ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="grid grid-cols-3 gap-2 w-full max-w-[420px]">
        ...
        <motion.button 
          ...
          className="flex flex-col items-center justify-center p-3 rounded-xl border border-slate-700/50 bg-slate-900/60 hover:bg-slate-800/80 hover:border-slate-500 text-slate-200 transition-all text-center group"
        >
          <div className="mb-2 p-2 bg-slate-800 text-slate-300 rounded-full transition-transform group-hover:bg-slate-700 group-hover:text-indigo-400 group-hover:rotate-12">
            <Users size={20} />
          </div>
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-200">Thư Viện ST</span>
          <span className="text-[8px] text-slate-400 font-medium opacity-80 uppercase mt-0.5">Nhân Vật SillyTavern</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-[11px] font-bold uppercase tracking-wider text-slate-200">Bản Sơ Đồ</span>
          <span className="text-[8px] text-slate-400 font-medium opacity-80 uppercase mt-0.5">Thiết kế Sơ Đồ Custom</span>
        </motion.button>
