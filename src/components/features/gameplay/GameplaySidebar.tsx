    ...
    return (
        <div className="h-full flex flex-col bg-stone-300 dark:bg-mystic-900 shadow-xl">
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2.5 space-y-3 min-h-0">
                    <div className="p-2 border border-stone-400/20 bg-stone-400/10 dark:bg-mystic-800/10 rounded-2xl space-y-2">
                ...
                <div className="grid grid-cols-5 gap-1">
                    ...
                    <button onClick={() => setShowCalendarModal(true)} className="flex flex-col items-center justify-center p-1 py-1.5 gap-1 text-[9px] font-bold text-stone-600 dark:text-slate-300 bg-stone-200 dark:bg-slate-800/40 hover:bg-stone-300 dark:hover:bg-slate-800/80 border border-stone-400/70 dark:border-slate-750 rounded-lg transition-all group" title="Sổ lịch trình 7 ngày">
                        <Calendar className="text-amber-500" size={12}/>
                        <span className="truncate">Lịch trình</span>
                    </button>
                    <button onClick={() => setShowFateSettingsModal?.(true)} className="flex flex-col items-center justify-center p-1 py-1.5 gap-1 text-[9px] font-bold text-stone-600 dark:text-slate-300 bg-stone-200 dark:bg-slate-800/40 hover:bg-stone-300 dark:hover:bg-slate-800/80 border border-stone-400/70 dark:border-slate-750 rounded-lg transition-all group" title="Cấu hình Xúc xắc Định mệnh D&D">
                        <Dices className="text-orange-500" size={12}/>
                        <span className="truncate">Số phận</span>
                    </button>
                </div>
            ...
            <div className="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-1 space-y-2">
                ...
                <button 
                  ...
                  className="w-full p-2 flex justify-between items-center text-left hover:bg-mystic-accent/10 dark:hover:bg-mystic-accent/5 transition-all bg-stone-200 dark:bg-slate-800/30 rounded border border-stone-400 dark:border-slate-700 group mb-3"
                >
