...
const ContextWindowModal: React.FC<ContextWindowModalProps> = ({
                ...
                <div className="flex items-center gap-2.5">
                    ...
                    <div className="text-left w-full">
                        <h2 className={`font-bold text-stone-850 dark:text-slate-100 flex items-center gap-1.5 ${isInline ? 'text-sm/tight' : 'text-lg'}`}>
                            ...
                            {!isInline && <span className="text-[10px] font-black uppercase text-mystic-accent bg-mystic-accent/10 px-2 py-0.5 rounded border border-mystic-accent/20 animate-pulse">Advanced Edition</span>}
                        </h2>
                        {!isInline && (
                        ...
                        {isInline && <p className="text-[9px] text-stone-500 uppercase tracking-widest font-bold">Cưỡng chế tối ưu ngôn từ AI Tawa</p>}
                    </div>
                </div>
                        ...
                        {tabsToRender.includes('rules') && (
                            <button
                                ...
                                className={`text-xs font-bold uppercase tracking-wider rounded-md transition-all flex items-center justify-center gap-1 ${
                                    isInline ? 'py-1 text-[9px]' : 'px-4 py-1.5'
                                } ${
                        ...
                        {isInline ? (
                            <div className="p-2.5 bg-stone-200 dark:bg-slate-900/50 rounded-lg border border-stone-300 dark:border-slate-850 flex justify-between items-center w-full gap-2 text-left">
                                <div className="flex gap-2 items-start">
                                    ...
                                    <p className="text-[10px] text-stone-605 dark:text-slate-450 leading-normal">
                                ...
                                <button 
                                    ...
                                    className="px-2 py-1 bg-stone-300 dark:bg-slate-800 hover:bg-mystic-accent hover:text-mystic-900 rounded-lg text-[9px] font-bold uppercase tracking-wider transition-all whitespace-nowrap shrink-0"
                                >
                                    Nhập/Xuất
                                </button>
                            </div>
                            ...
                            <div className="p-4 bg-stone-200 dark:bg-slate-900/50 rounded-xl border border-stone-300 dark:border-slate-800 flex justify-between items-center max-w-7xl mx-auto w-full gap-4">
                                <div className="flex gap-3 items-start text-left">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[11px] text-stone-605 dark:text-slate-450 leading-relaxed mt-0.5">
                                    ...
                                    <div className="max-w-7xl mx-auto w-full space-y-4">
                                        ...
                                        {filteredRules.length === 0 ? (
                                            <div className="p-12 border-2 border-dashed border-stone-300 dark:border-slate-800 rounded-xl text-center space-y-2 bg-stone-200/50 dark:bg-slate-900/10 max-w-7xl mx-auto w-full">
                                                ...
                                                <p className="text-[10px] text-stone-400 dark:text-slate-600 max-w-sm mx-auto">
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <div className="flex flex-col items-center justify-between shrink-0 text-stone-400 border-r border-stone-300 dark:border-slate-800 pr-3 select-none">
                                                                <span className="text-[10px] font-black font-mono text-mystic-accent bg-mystic-accent/5 px-1.5 py-0.5 rounded border border-mystic-accent/10">
                                                                    #{parsedRule.index + 1}
                                                                </span>
                                                            ...
                                                            {isEditing && (
                                                                <div className="absolute top-3 right-4 flex items-center gap-1 bg-amber-500 text-stone-950 font-black text-[9px] uppercase tracking-widest px-2 py-0.5 rounded-full animate-pulse shadow-sm">
                                                                ...
                                                                {isEditing ? (
                                                                    ...
                                                                    <div className="space-y-2">
                                                                        ...
                                                                        <div className="flex flex-wrap gap-2 items-center">
                                                                            <span className={`text-[10px] font-black px-2 py-0.5 rounded border ${catStyle.bg} ${catStyle.text} ${catStyle.border}`}>
                                                                                {parsedRule.category}
                                                                            </span>
                                                                            <span className={`text-[9px] font-black px-2 py-0.5 rounded border inline-flex items-center gap-1.5 ${prioStyle.badge}`}>
                                                                            ...
                                                                            {hasCond ? (
                                                                                condEval.active ? (
                                                                                    <span className="text-[9px] font-black px-2 py-0.5 rounded bg-emerald-500/10 text-emerald-500 border border-emerald-500/20 inline-flex items-center gap-1">
                                                                                        <span>⚡ KÍCH HOẠT</span>
                                                                                        <span className="font-mono text-[8px] opacity-80">({condEval.label})</span>
                                                                                    </span>
                                                                                ) : (
                                                                                    <span className="text-[9px] font-black px-2 py-0.5 rounded bg-stone-300/40 dark:bg-slate-800 text-stone-500 dark:text-slate-450 border border-stone-350 dark:border-slate-800 inline-flex items-center gap-1">
                                                                                        <span>⏳ CHỜ ĐIỀU KIỆN</span>
                                                                                        <span className="font-mono text-[0.8em] opacity-80">({condEval.label})</span>
                                                                                    </span>
                                                                                )
                                                                            ) : (
                                                                                <span className="text-[9px] font-black px-2 py-0.5 rounded bg-sky-500/10 text-sky-500 border border-sky-500/15">
                                                                                    🔥 LUÔN THI HÀNH
                                                                                </span>
                                                                            )}
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="p-5 bg-stone-200 dark:bg-slate-900/50 rounded-xl border border-stone-300 dark:border-slate-800 text-left">
                                                ...
                                                />
                                                <div className="flex justify-between text-[10px] text-stone-500 mt-2 font-bold select-none">
                                                    <span>1 NPC</span>
                                                    <span>50 NPCs</span>
                                                </div>
                                            </div>
                                            ...
                                            <div className="p-5 bg-stone-200 dark:bg-slate-900/50 rounded-xl border border-stone-300 dark:border-slate-800 text-left">
                                                ...
                                                <input 
                                                    ...
                                                    className="w-full h-2 bg-stone-300 dark:bg-slate-800 rounded-lg appearance-none cursor-pointer accent-mystic-accent"
                                                />
                                                <div className="flex justify-between text-[10px] text-stone-550 mt-2 font-bold select-none">
                                                    <span>4k Tokens</span>
    ...
    return (
        <AnimatePresence>
            {show && (
                <div className="fixed inset-0 z-[150] flex items-center justify-center bg-black/80 backdrop-blur-sm p-0 md:p-4 pointer-events-auto">
                    <motion.div
                        initial={{ opacity: 0, scale: 0.95 }}
                        animate={{ opacity: 1, scale: 1 }}
                        exit={{ opacity: 0, scale: 0.95 }}
                        transition={{ duration: 0.23, ease: 'easeOut' }}
                        className="w-[99vw] h-[99vh] relative bg-stone-200 dark:bg-mystic-950 border border-stone-400 dark:border-slate-800 rounded-xl shadow-2xl overflow-hidden flex flex-col animate-presence"
                    >
                        {content}
                    </motion.div>
                </div>
