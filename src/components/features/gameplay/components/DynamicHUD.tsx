                ...
                <div className="flex items-center gap-4 flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2.5 overflow-x-auto select-none no-scrollbar flex-1 pb-1 md:pb-0">
                        ...
                        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/40 border border-white/5 shrink-0 shadow-inner">
                            ...
                            <span className="text-[10px] font-bold text-slate-200 font-mono">{environmentTheme.timeStr}</span>
                        </div>

                        {/* Location Badge */}
                        <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/40 border border-white/5 shrink-0 shadow-inner">
                            {environmentTheme.sceneryIcon}
                            <span className="text-[10px] font-bold text-slate-200 truncate max-w-[140px] md:max-w-[200px]">{locationString}</span>
                        </div>

                        {/* Mini HP & MP bar indicators directly visible in Header */}
                        {healthStat && (
                            <div className="hidden sm:flex flex-col gap-1 w-20 md:w-28 shrink-0 bg-black/25 px-2 py-1 rounded border border-white/5">
                                <div className="flex justify-between text-[8px] font-mono font-bold leading-none text-slate-400">
                                    <span>HP</span>
                                    <span className="text-rose-400">{healthStat.value}</span>
                                </div>
                        ...
                        {(activeQuest || currentObjective) && (
                            <div className="hidden lg:flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-black/40 border border-white/5 shrink-0 shadow-inner">
                                <Target size={11} className="text-amber-400" />
                                <span className="text-[10px] font-semibold text-slate-300 truncate max-w-[200px]">
